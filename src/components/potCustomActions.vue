<template>
  <div class="custom-actions">
    ...
    <router-link v-bind:to="'pot/' + rowData.id"><button class="ui basic button"><i class="edit icon"></i></button></router-link>
...
export default {
  ...
  methods: {
    ...
    confirmDelete () {
      if (window.confirm("Do you really want to delete pot of id '" + this.rowData
          .id + "'?")) {
        this.deleteInstance()
      }
    },

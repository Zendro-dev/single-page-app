...
//lazy loading
const RoleToUserAttributesPage = lazy(() => retry(() => import(/* webpackChunkName: "Create-AttributesRoleToUser" */ './components/role_to_user-attributes-page/Role_to_userAttributesPage')));
const RoleToUserAssociationsPage = lazy(() => retry(() => import(/* webpackChunkName: "Create-AssociationsRoleToUser" */ './components/role_to_user-associations-page/Role_to_userAssociationsPage')));
const RoleToUserConfirmationDialog = lazy(() => retry(() => import(/* webpackChunkName: "Create-ConfirmationRoleToUser" */ './components/Role_to_userConfirmationDialog')));

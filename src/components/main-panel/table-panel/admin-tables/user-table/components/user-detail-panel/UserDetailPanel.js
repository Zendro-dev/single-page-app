...
//lazy loading
const UserAttributesPage = lazy(() => retry(() => import(/* webpackChunkName: "Detail-Attributes-User" */ './components/user-attributes-page/UserAttributesPage')));
const UserAssociationsPage = lazy(() => retry(() => import(/* webpackChunkName: "Detail-Associations-User" */ './components/user-associations-page/UserAssociationsPage')));
const UserUpdatePanel = lazy(() => retry(() => import(/* webpackChunkName: "Detail-Update-User" */ '../user-update-panel/UserUpdatePanel')));
const UserDeleteConfirmationDialog = lazy(() => retry(() => import(/* webpackChunkName: "Detail-Delete-User" */ '../UserDeleteConfirmationDialog')));
const RoleDetailPanel = lazy(() => retry(() => import(/* webpackChunkName: "Detail-Detail-Role" */ '../../../role-table/components/role-detail-panel/RoleDetailPanel')));
  ...
  return (
    <div>
      ...
      {(roleDetailDialogOpen) && (
        <Suspense fallback={<div />}><ErrorBoundary showMessage={true} belowToolbar={true} dialog={true} open={roleDetailDialogOpen} handleClose={handleRoleDetailDialogClose}>
          <RoleDetailPanel
            permissions={permissions}
            item={roleDetailItem}
            dialog={true}

...
//lazy loading
const RoleAttributesPage = lazy(() => retry(() => import(/* webpackChunkName: "Update-Attributes-Role" */ './components/role-attributes-page/RoleAttributesPage')));
const RoleAssociationsPage = lazy(() => retry(() => import(/* webpackChunkName: "Update-Associations-Role" */ './components/role-associations-page/RoleAssociationsPage')));
const RoleConfirmationDialog = lazy(() => retry(() => import(/* webpackChunkName: "Update-Confirmation-Role" */ './components/RoleConfirmationDialog')));
const UserDetailPanel = lazy(() => retry(() => import(/* webpackChunkName: "Update-Detail-User" */ '../../../user-table/components/user-detail-panel/UserDetailPanel')));
    ...
    >
      ...
      <div className={classes.root}>
        ...
        {(userDetailDialogOpen) && (
          <Suspense fallback={<div />}><ErrorBoundary showMessage={true} belowToolbar={true} dialog={true} open={userDetailDialogOpen} handleClose={handleUserDetailDialogClose}>
            <UserDetailPanel

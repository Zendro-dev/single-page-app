...
//lazy loading
const RoleAttributesPage = lazy(() => retry(() => import(/* webpackChunkName: "Create-AttributesRole" */ './components/role-attributes-page/RoleAttributesPage')));
const RoleAssociationsPage = lazy(() => retry(() => import(/* webpackChunkName: "Create-AssociationsRole" */ './components/role-associations-page/RoleAssociationsPage')));
const RoleConfirmationDialog = lazy(() => retry(() => import(/* webpackChunkName: "Create-ConfirmationRole" */ './components/RoleConfirmationDialog')));
const UserDetailPanel = lazy(() => retry(() => import(/* webpackChunkName: "Create-DetailUser" */ '../../../user-table/components/user-detail-panel/UserDetailPanel')));

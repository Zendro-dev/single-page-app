...
//lazy loading
const RoleAttributesPage = lazy(() => retry(() => import(/* webpackChunkName: "Detail-Attributes-Role" */ './components/role-attributes-page/RoleAttributesPage')));
const RoleAssociationsPage = lazy(() => retry(() => import(/* webpackChunkName: "Detail-Associations-Role" */ './components/role-associations-page/RoleAssociationsPage')));
const RoleUpdatePanel = lazy(() => retry(() => import(/* webpackChunkName: "Detail-Update-Role" */ '../role-update-panel/RoleUpdatePanel')));
const RoleDeleteConfirmationDialog = lazy(() => retry(() => import(/* webpackChunkName: "Detail-Delete-Role" */ '../RoleDeleteConfirmationDialog')));
const UserDetailPanel = lazy(() => retry(() => import(/* webpackChunkName: "Detail-Detail-User" */ '../../../user-table/components/user-detail-panel/UserDetailPanel')));

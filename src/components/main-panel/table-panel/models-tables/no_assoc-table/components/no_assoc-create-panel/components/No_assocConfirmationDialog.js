...
export default function NoAssocConfirmationDialog(props) {
  ...
  return (
    <div>
      <Dialog id='NoAssocConfirmationDialog-create'
        open={open}
      ...
      >
        ...
        <DialogActions>
          ...
          {(acceptText !== '' && acceptText !== null && acceptText !== undefined) &&
            <Button
              id='NoAssocConfirmationDialog-create-button-accept'
              color="primary"
              variant='contained'
          ...
          {(rejectText !== '' && acceptText !== null && acceptText !== undefined) &&
            ...
            <Button
              id='NoAssocConfirmationDialog-create-button-reject'
              color="primary" 
...
NoAssocConfirmationDialog.propTypes = {

...
//lazy loading
const NoAssocDetailPanel = lazy(() => retry(() => import(/* webpackChunkName: "Delete-DetailNoAssoc" */ './no_assoc-detail-panel/No_assocDetailPanel')));
...
export default function NoAssocDeleteConfirmationDialog(props) {
  ...
  return (
    ...
    >
      ...
      {(!deleted) && (
        <DialogActions>
          <Button 
          id='NoAssocDeleteConfirmationDialog-button-reject'
          ...
          <Button 
          id='NoAssocDeleteConfirmationDialog-button-accept'
...
NoAssocDeleteConfirmationDialog.propTypes = {

...
export default function RolesToRemoveTransferView(props) {
  ...
  */
      ...
      .then(response => {
          if (
              ...
              */
              ...
              console.log("@@newItems: ", response.data.data.readOneUser.rolesFilter);
  ...
  function getDataB() {
    ...
    */
    api.roleB.getCountItems(graphqlServerUrl, searchB, ops)
      .then(response => {
        if (
          response.data &&
          response.data.data
                                ...
                                <Grid container justify='center' alignItems='center' wrap='nowrap'>
                                  ...
                                  <Grid item xs={2}>
                                    <Grid container justify='flex-end'>
                                      <Grid item>
                                        <Tooltip title={!disabled ? "Send to to-remove list" : "Already on to-remove list"}>
                                          <span>
                                            <IconButton
                                              color="primary"
                                              ...
                                              disabled={disabled}
                                            >
                                              <Remove color={!disabled ? "secondary" : "default"} />
                                            </IconButton>
                                          </span>
                                        </Tooltip>
                                      </Grid>
                            ...
                            <Grid container justify='flex-end' alignItems='center'>
                              <Grid item xs={12}>
                                <Grid container justify='space-evenly' alignItems='center' alignContent='stretch' wrap='nowrap'>
                                  ...
                                  {/* Button: Add */}
                                  <Grid item xs={2}>
                                    <Tooltip title="Remove from to-remove list">
                                      <IconButton
                                        color="primary"
                                        onClick={(event) => {
                                          event.stopPropagation();

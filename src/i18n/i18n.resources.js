    ...
    translation: {
      login: {
        ...
        errors: {
          ...
          e7:
            'ACL module could not be implemented. Please contact your administrator.',
        },
      },
      mainPanel: {
        home: 'Home',
      ...
      modelPanels: {
        ...
        plot1: {
          title: 'Bar chart',
          description:
            "Select a model attribute and click on button 'generate plot' to generate a frequency distribution bar chart of the selected attribute.",
          label: 'Attributes',
          none: 'None',
        ...
        cancelChangesB:
          'Some fields have been edited, if you continue without save, the changes will be lost, you want to continue?',
        //warnings
        ...
        messages: {
          ...
          seeConsoleError:
            'Please see console log for more details on this error',
        },
        errors: {
          ...
          e2:
            'An error occurred while trying to execute the GraphQL query, cannot process server response. Please contact your administrator.',
          e3:
            'The GraphQL query returned a response with errors. Please contact your administrator.',
          data: {
  ...
  de: {
    translation: {
      login: {
        ...
        errors: {
          e1:
            'Bitte geben Sie eine gültige Email-Adresse ein. Beispiel: meineEmail@unternehmen.abc',
          e2: 'Passwort wird benötigt',
          e3:
            'Die von Ihnen angegebenen Anmeldeinformationen sind nicht korrekt.',
          e4: 'Das vom Server empfangene Token konnte nicht validiert werden.',
          e5:
            'Verbindung zum Server konnte nicht hergestellt werden. Bitte wenden Sie sich an Ihren Netzwerkadministrator.',
          e6:
            'Beim Versuch, eine Verbindung zum Server herzustellen, ist ein Fehler aufgetreten. Bitte wenden Sie sich an Ihren Administrator.',
          e7:
            'ACL-Modul konnte nicht implementiert werden. Bitte wenden Sie sich an Ihren Administrator.',
        },
      },
      mainPanel: {
        home: 'Zuhause',
      ...
      modelPanels: {
        ...
        plot1: {
          ...
          description:
            "Wählen Sie ein Modellattribut aus und klicken Sie auf die Schaltfläche 'Plot generieren', um ein Häufigkeitsverteilungsbalkendiagramm des ausgewählten Attributs zu erstellen.",
          label: 'Attribute',
          none: 'Keiner',
        ...
        upload: 'Hochladen',
        uploadHelper:
          'Bitte wählen Sie die CSV-Datei aus, die Sie importieren möchten.',
        //delete confirmation dialog
        ...
        //cancelChanges
        cancelChanges:
          'Die bearbeiteten Informationen wurden nicht gespeichert',
        cancelChangesB:
          'Einige Felder wurden bearbeitet. Wenn Sie ohne Speichern fortfahren, gehen die Änderungen verloren. Möchten Sie fortfahren?',
        //warnings
        deletedWarning:
          'Dieser Artikel existiert nicht mehr. Es wurde an anderer Stelle gelöscht.',
        ...
        //float & int
        floatMaxErr:
          'Dies ist ein Float-Feld. Die maximal gültige positive Zahl ist 1.79769313486231e+308. Eingegebener Wert: ',
        floatMinErr:
          'Dies ist ein Float-Feld. Die minimal gültige negative Zahl ist -1,79769313486231e+308. Eingegebener Wert: ',
        intMaxErr:
          'Dies ist ein Int-Feld, die maximal gültige positive Zahl ist 2147483647. Eingegebener Wert: ',
        intMinErr:
          'Dies ist ein Int-Feld, die minimal gültige negative Zahl ist -2147483647. Eingegebener Wert: ',
        intRoundedWarning:
          'Dies ist ein Int-Feld. Die Dezimalstellen werden gerundet. Wert genommen: ',
        valueTaken: 'Wert genommen: ',
        invalidNumber: 'Ungültige Nummer',
        undefinedNumber:
          'Undefinierte Nummer, in diesem Feld wird kein Wert zur Änderung gesendet.',
        number: 'nummer',
        integer: 'ganze Zahl',
        ...
        messages: {
          msg1:
            'Die Daten wurden gesendet. Ein Bericht mit dem Status des Importvorgangs wird an Ihre E-Mail gesendet.',
          msg2:
            'NULL-Daten empfangen: Die GraphQL-Abfrage gibt keine Daten zurück.',
          ...
          //no permissions
          msg8:
            'Sie benötigen Berechtigungen, um auf diesen Abschnitt zugreifen zu können.',
          ...
          goodConnection:
            'Stellen Sie sicher, dass Sie eine gute Netzwerkverbindung haben',
          apiCouldNotLoaded: 'API konnte nicht geladen werden',
          seeConsoleError:
            'Weitere Informationen zu diesem Fehler finden Sie im Konsolenprotokoll',
        },
        errors: {
          details: 'Fehlerdetails:',
          noDetails: 'Keine Fehlerdetails.',
          e1:
            'Beim Versuch, die GraphQL-Abfrage auszuführen, ist ein Fehler aufgetreten. Bitte wenden Sie sich an Ihren Administrator.',
          e2:
            'Beim Versuch, die GraphQL-Abfrage auszuführen, ist ein Fehler aufgetreten. Die Serverantwort kann nicht verarbeitet werden. Bitte wenden Sie sich an Ihren Administrator.',
          e3:
            'Die GraphQL-Abfrage hat eine Antwort mit Fehlern zurückgegeben. Bitte wenden Sie sich an Ihren Administrator.',
          data: {
  ...
  es: {
    translation: {
      login: {
        ...
        errors: {
          e1:
            'Por favor ingrese un correo electrónico válido. Por ejemplo: miCorreo@dominio.abc',
          ...
          e5:
            'No se puede establecer conexión con el servidor. Por favor contacte al administrador de la red.',
          e6:
            'Ocurrió un error al intentar contactar con el servidor. Por favor contacte al administrador de la aplicación.',
          e7:
            'Ocurrió un error con el módulo ACL. Por favor contacte al administrador de la aplicación.',
        },
      },
      mainPanel: {
        home: 'Inicio',
      ...
      modelPanels: {
        ...
        plot1: {
          ...
          description:
            "Seleccione un atributo y de click en el botón 'generar plot' para generar una gráfica de distribución de frecuencia sobre el atributo seleccionado.",
          label: 'Atributos',
          none: 'Ninguno',
          button: 'Generar plot',
        },
        ...
        cancelChangesB:
          'Algunos campos han sido editados, si continua sin guardar, estos cambios se perderán, ¿desea continuar?',
        //warnings
        deletedWarning:
          'Este registro ya no existe. Fue borrado en alguna otra parte.',
        ...
        //float & int
        floatMaxErr:
          'Este es un campo tipo Float, el máximo valor positivo válido es 1.79769313486231e+308. Valor ingresado: ',
        floatMinErr:
          'Este es un campo tipo Float, el mínimo valor negativo válido es -1.79769313486231e+308. Valor ingresado: ',
        intMaxErr:
          'Este es un campo tipo Int, el valor positivo máximo válido es 2147483647. Valor ingresado: ',
        intMinErr:
          'Este es un campo tipo Int, el valor negativo mínimo válido es -2147483647. Valor ingresado: ',
        intRoundedWarning:
          'Este es un campo tipo Int, los decimales serán redondeados. Valor tomado: ',
        valueTaken: 'Valor tomado: ',
        invalidNumber: 'Número no válido',
        undefinedNumber:
          'Número indefinido, no se enviará ningún valor para modificar sobre este campo.',
        number: 'número',
        integer: 'entero',
        ...
        messages: {
          msg1:
            'Los datos se han enviado. Un informe con el estatus del proceso de importación será enviado a su correo electrónico.',
          msg2:
            'Datos null recibidos: la consulta GraphQL no devolvió información.',
          ...
          goodConnection:
            'Por favor asegúrese de tener una buena conexión de red',
          apiCouldNotLoaded: 'No se pudo cargar la petición API',
          seeConsoleError:
            'Por favor vea la consola de log para obtener más información sobre este error',
        },
        errors: {
          details: 'Detalles del error:',
          noDetails: 'No hay más información del error.',
          e1:
            'Ocurrió un error al intentar ejecutar la consulta GraphQL. Por favor contacte al administrador de la aplicación.',
          e2:
            'Ocurrió un error al intentar ejecutar la consulta GraphQL, no se puede procesar la respuesta recibida del servidor. Por favor contacte al administrador de la aplicación.',
          e3:
            'La consulta GraphQL retornó una respuesta con errores. Por favor contacte al administrador de la aplicación.',
          data: {

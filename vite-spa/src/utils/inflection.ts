// Default import, not `import { pluralize } from 'inflection'` - this
// package is CommonJS-only with no static export analysis Node's own ESM
// loader can rely on (unlike esbuild/Vite's looser interop, which tolerates
// the named form fine in the browser bundle) - this file also runs under
// plain Node in scripts/generate.ts, where the named form throws.
import inflectionPkg from 'inflection';
const { pluralize } = inflectionPkg;

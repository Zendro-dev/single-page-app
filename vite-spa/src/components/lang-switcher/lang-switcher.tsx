// ClientOnly (used here in the original) existed purely to avoid Next SSR
// hydration mismatches - this app has no SSR at all (pure CSR), so it's
// dropped rather than ported; there's nothing left for it to guard against.
